...
export default function Fridge(props) {
    const ingredientArr = props.ingr;
    ...
    return (
        <>
            ...
            <Dialog fullWidth={true} maxWidth={'sm'}open={openEditModal} onClose={() => { setOpenEditModal(false) }} >
                ...
                <Grid item>
                    ...
                    <Button
                        ...
                        onClick={async () => {
                            ...
                            var idxx = await indexMatch(fridge, searchFridge);
                            setIdx(idxx);
                        }}>
                        Enter
                    </Button>
